...
#1. python3.6和apache2.4.25都是通过repo来安装的
#httpd24.x86_64                  1.1-14.el7                       @centos-sclo-rh
#httpd24-httpd.x86_64            2.4.25-9.el7                     @centos-sclo-rh
#httpd24-httpd-devel.x86_64      2.4.25-9.el7                     @centos-sclo-rh
#httpd24-httpd-tools.x86_64      2.4.25-9.el7                     @centos-sclo-rh
#httpd24-libnghttp2.x86_64       1.7.1-1.el7                      @centos-sclo-rh
#httpd24-mod_ssl.x86_64          1:2.4.25-9.el7                   @centos-sclo-rh
#httpd24-runtime.x86_64          1.1-14.el7                       @centos-sclo-rh
...
#python36u-devel Development tools必须安装，要不然cchardet fastcache lru-dict三者都会安装失败。
...
# Install the latest version of pip, supported by a legacy Python
	wget --no-check-certificate https://bootstrap.pypa.io/get-pip.py | python3.6
	 fi

pip3.6 list| grep Flask >/dev/null 2>&1 && pip3 list| grep requests >/dev/null 2>&1
if [ $? -ne 0 ]; then
